...
export default function Inventory() {
    ...
    function updateSelectProduct(product: Product) {
        setSelectedProduct(product);
        setEditMode(true);
    }

    function updateDeleteProduct(id: number) {
        setLoading(true);
        setTarget(id)
                    ...
                    <TableBody>
                        {products.map((product) => (
                            ...
                            >
                                ...
                                <TableCell align="center">{product.theme}</TableCell>
                                <TableCell align="center">{product.quantityInStock}</TableCell>
                                <TableCell align="right">
                                    <Button onClick={() => updateSelectProduct(product)} startIcon={<Edit />} />
                                    <LoadingButton
                                        loading={loading && target === product.id}
                                        onClick={() => updateDeleteProduct(product.id)}
